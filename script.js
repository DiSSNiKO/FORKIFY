...
//global vars
let currentRecipes = [];
let showpaginationbuttons = false;
let currentPage = 0;
        ...
        if(!request.ok) {
            ...
            <div class="image-and-bookmark">
                ...
                <div class="serving-time-bookmark">
                    <div>
                        <div class="cook-time"><svg><use href="src/img/icons.svg#icon-clock"></use></svg> <strong>${recipe.cooking_time}</strong> Minutes</div>
                        <div class="serving-size-cont"><svg><use href="src/img/icons.svg#icon-users"></use></svg><strong>${recipe.servings}</strong>Servings<div class="inc-dec-servings"><svg><use href="src/img/icons.svg#icon-minus-circle"></use></svg><svg><use href="src/img/icons.svg#icon-plus-circle"></use></svg></div></div>
                    </div>
            ...
            <div class="go-to-instructions">
                ...
                <span>This recipe was carefully designed and tested by <strong>${recipe.publisher}</strong>. Please check out directions on their website.</span>
                <a href="${recipe.source_url}">DIRECTIONS<svg><use href="src/img/icons.svg#icon-arrow-right"></use></svg></a>
            </div>
            `);
            recipeDetails.dataset.recipeId = recipe.recipe_id;
